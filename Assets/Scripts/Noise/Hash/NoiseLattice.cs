...
namespace Noise.Hash
{
    public static partial class Noise
    {
        ...
        static LatticeSpan4 GetLatticSpan4(float4 coordinates)
        {
        ...
        public struct Lattice2D : INoise
        {
            public float4 GetNoise4(float4x3 positions, SmallXXHash4 hash)
            {
                LatticeSpan4 x = GetLatticSpan4(positions.c0), z = GetLatticSpan4(positions.c2);
        ...
        public struct Lattice3D : INoise
        {
            public float4 GetNoise4(float4x3 positions, SmallXXHash4 hash)
            {
                LatticeSpan4 x = GetLatticSpan4(positions.c0), y = GetLatticSpan4(positions.c1), z = GetLatticSpan4(positions.c2);
